...
function BookDetails() {
    ...
    useEffect(() => {
        ...
        async function getBookData() {
            try {
                ...
                toast.error("Error while fetching BookDetails");
            }
        }
        getBookData();
    }, [])
    ...
    const dummy={
      ...
      authorBio: `Dr. ${book.author?book.author:'Ed sheeran'} is a leading blockchain researcher and consultant with over 15 years of experience in distributed systems. She holds a Ph.D. in Computer Science from MIT and has worked with Fortune 500 companies to implement blockchain solutions. She is a frequent speaker at technology conferences and has published numerous papers on blockchain technology.`,
    }
                    ...
                    <section className={styles.bookHeader} data-aos="fade-up">
                        <div className={styles.bookCover}>
                            <div className={styles.coverDesign}>
                                <div className={styles.coverTitle}>{book.name}</div>
                            ...
                            <div className={styles.bookMeta}>
                                ...
                                <div className={styles.bookStats}>
                                    <div className={styles.stat}>
                                        ...
                                        <span className={styles.statValue}>{book.pages?book.pages:'250+'}</span>
                                    </div>
                                    <div className={styles.stat}>
                                        <span className={styles.statLabel}>Language:</span>
                                        <span className={styles.statValue}>{book.language?book.language:'English'}</span>
                                    </div>
                                    <div className={styles.stat}>
                                        <span className={styles.statLabel}>Published:</span>
                                        <span className={styles.statValue}>{book.publishDate?book.publishDate:'June 07 2018'}</span>
                                    </div>
                                </div>
                            </div>
